...
from model import build_rope_cache, apply_rope, RMSNorm, MLP
...
class Block(nn.Module):
    """The implementation is identical to `model.Block` with the exception that
...
class LLaMA(llama.LLaMA):
    """The implementation is identical to `model.LLaMA` with the exception that
